...
[Defines]
  ...
  BOARD_DXE_FV_COMPONENTS        = Platform/Radxa/E25/E25.fdf.inc
...
[PcdsFixedAtBuild.common]
  ...
  gRk356xTokenSpaceGuid.PcdPlatformName|"Radxa E25"
  ...
  gRk356xTokenSpaceGuid.PcdProductUrl|"https://wiki.radxa.com/Rock3/CM3p/e25"
...
!if $(PCIE2x1_ENABLE) == TRUE
  ...
  gRk356xTokenSpaceGuid.PcdPciePowerGpioPin|23
!endif
  
!if $(PCIE3x1_ENABLE) == TRUE
  gArmTokenSpaceGuid.PcdPciBusMin|0
  gArmTokenSpaceGuid.PcdPciBusMax|1
  gArmTokenSpaceGuid.PcdPciMmio32Base|0xF2000000
  gArmTokenSpaceGuid.PcdPciMmio32Size|0x02000000
  gArmTokenSpaceGuid.PcdPciMmio64Base|0x0000000350000000
  gArmTokenSpaceGuid.PcdPciMmio64Size|0x000000002FFF0000
  gArmTokenSpaceGuid.PcdPciIoBase|0x0000
  gArmTokenSpaceGuid.PcdPciIoSize|0x10000
  ...
  gEfiMdePkgTokenSpaceGuid.PcdPciExpressBaseAddress|0x0000000340000000
  ...
  gRk356xTokenSpaceGuid.PcdPciePowerGpioBank|0
  gRk356xTokenSpaceGuid.PcdPciePowerGpioPin|21
!endif
  
!if $(PCIE3x2_ENABLE) == TRUE
  gArmTokenSpaceGuid.PcdPciBusMin|0
  gArmTokenSpaceGuid.PcdPciBusMax|1
  ...
  gRk356xTokenSpaceGuid.PcdPcieLinkSpeed|0x2
  gRk356xTokenSpaceGuid.PcdPcieNumLanes|0x2
  gRk356xTokenSpaceGuid.PcdPcie30PhyLane0LinkNum|1
  gRk356xTokenSpaceGuid.PcdPcie30PhyLane1LinkNum|1
...
!endif
  ...
  #
  # The RADXA-E25 board has inverted polarity for the PWREN pin on the SD card slot
  #
...
[Components.common]
  ...
  # Board specific
  #
  Platform/Radxa/E25/Drivers/BoardInitDxe/BoardInitDxe.inf
